...
class WordEmbeddings:
    ...
    def __init__(self, word_indexer, vectors):
        self.word_indexer = word_indexer # list of 14923 words
        self.vectors = vectors # 14923,50
    ...
    def get_initialized_embedding_layer(self, frozen=True):
        ...
        """
        return torch.nn.Embedding.from_pretrained(torch.FloatTensor(self.vectors), freeze=frozen), self.word_indexer
...
def create_random_embeddings(emb_file):
...
if __name__=="__main__":
    ...
    # exit()
    import sys
    embs = read_word_embeddings("data/glove.6B.300d-relativized.txt") # 50d, 300d
